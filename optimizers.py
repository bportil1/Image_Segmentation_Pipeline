...
class SwarmBasedAnnealingOptimizer:
    def __init__(self, similarity_matrix, generate_edge_weights, error_computation, gradient_function, gamma, num_particles, dimensions, max_iter, h=0.99): #, c1=1.5, c2=1.5):
    ...
    def compute_error(self, particle_idx):
        print(particle_idx)
        curr_sim_matr = self.generate_edge_weights(self.positions[particle_idx])
